---
title: 'Dimensional Modeling - Four-Step Design Process'
date: '2025-07-02'
...
> `Dimensions` are the objects or context. That is – dimensions are the 'things' about which something is being spoken.
...
> Measures are not stored in Dimension tables, but in Fact tables.
> When we talk about Measures we ALWAYS refer to Fact tables.
...
_What does the first record of the table mean?_

On day 1/01/2022 in the store Mc Florence a total of 5 French Fries have been sold for a total value of 10 euros
