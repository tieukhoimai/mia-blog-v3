...
_This article is based on my personal lecture notes from my studies at Machine Learning for Data Science 2023/2024 course: Bayesian Learning. The content reflects my understanding and interpretation of the course material._
...
1. Duda, R. O., Hart, P. E., & Stork, D. G. (2001). Chapter 2: Bayesian decision theory. In _Pattern Classification_. Wiley.
2. Naive Bayes Classifier Implementation. _[GitHub](https://github.com/vamc-stash/Naive-Bayes/blob/master/src/GaussianNB.py)_.
3. Chapter 11: Naive Bayes Classifier. _[Github](https://github.com/tiepvupsu/ebookMLCB/blob/master/book_ML.pdf)_
4. [Understanding by Implementing: Gaussian Naive Bayes](https://towardsdatascience.com/learning-by-implementing-gaussian-naive-bayes-3f0e3d2c01b2). _Towards Data Science_.
