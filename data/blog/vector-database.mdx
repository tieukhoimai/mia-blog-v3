...
Then, utilize the `describe_index_stats` method to check.

```python
index.describe_index_stats()
```

It provides statistics specific to each namespace regarding the contents of all namespaces within an index.
