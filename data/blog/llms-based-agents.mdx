...
date: '2025-11-01'
tags: ['LLMs', 'Agentic AI', 'Multi-Agent']
draft: false
...
More precisely, an agent is any entity that:

- **Perceives** its environment — through tools, memory, and input
- **Acts autonomously** — by planning, reflecting, and executing actions

$\Rightarrow$ To achieve specific goals via a **well-designed cycle** that continuously improves toward its objectives.
...
<figure>
  ...
  <figcaption className="text-center text-sm text-gray-500 mt-2">
    Overview of an LLM-powered agent system. (Image source: [[3]](#ref-3))
  </figcaption>
</figure>
...
The Generative Agents architecture [[3]](#ref-3) offers a concrete illustration of how these components operate as a continuous cycle:

<figure>
  <img
    src="/static/images/resource/llms/GenerativeAgentMemory.png"
    alt="The generative agent memory architecture"
    className="w-[100%] mx-auto h-auto"
    loading="lazy"
  />
  <figcaption className="text-center text-sm text-gray-500 mt-2">
    The generative agent memory architecture. (Image source: [Park et al.
    2023](https://arxiv.org/abs/2304.03442))
  </figcaption>
</figure>

The agent **perceives** the environment and stores experiences in a **memory stream**. When acting, it **retrieves** past memories to guide decisions. It can **plan** and **reflect** on these experiences to improve behavior. Finally, it **acts** on the environment — and the cycle repeats.

The goal of designing an agent is not just to add more components, but to create **effective loops** — loops that allow the agent to perceive, remember, plan, and act in a way that consistently drives it toward achieving its objectives.
...
<figure>
  <img
    ...
    alt="Classification of LLM-based multi-agent systems"
    className="w-[100%] mx-auto h-auto"
    loading="lazy"
  />
  <figcaption className="text-center text-sm text-gray-500 mt-2">
    Classification of LLM-based multi-agent systems. (Image source: [[2]](#ref-2))
  </figcaption>
</figure>
