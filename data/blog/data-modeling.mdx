...
A surrogate key is called `surrogate` because it does not exist in the original information but it's calculated during the ETL phase. It is at 99% of cases an incremental number that is derived from other columns that represent the primary key of a table.

**Surrogate keys are useful for:**

- Improve query performance
- Save disk space
- Simplify join complexity
- Decouple source information code from DWH identifier
