...
Multi-head attention is a mechanism within transformers that extends self-attention by allowing the model to attend to different aspects of the input simultaneously. This is achieved by using multiple attention heads, each operating independently but in parallel. Each head can focus on different linguistic relationships or patterns within the context, such as syntactic dependencies, semantic relatedness, or coreference resolution.
...
- Speech and Language Processing. Daniel Jurafsky & James H. Martin. Copyright © 2024. Draft of August 20, 2024. CHAPTER
9, The Transformer