...
<div className="rounded-lg border-l-4 border-primary-500 bg-gray-50 p-2 dark:bg-gray-800">
  <h4 className="text-lg font-bold text-primary-600 dark:text-primary-400">Quick Recap</h4>-
