...
date: '2024-12-12'
tags: ['LLMs', 'Language Models', 'Transformer', 'RAG', 'Prompt Engineering', 'Fine-tuning']
draft: false
  ...
  <ul className="list-disc pl-5 space-y-2">
    <li>
      ...
      <ul className="list-[circle] pl-5 space-y-1">
        <li>
          <strong>Masked language modeling:</strong> Predicts masked tokens in a sentence.
        </li>
        <li>
          <strong>Smaller & older models:</strong> Still effective for information extraction tasks.
        </li>
      </ul>
    </li>
    <li>
      ...
      <ul className="list-[circle] pl-5 space-y-1">
        <li>
          <strong>Dominant LLM approach:</strong> Auto-regressive next-token generation.
        </li>
      </ul>
    </li>
    <li>
      ...
      <ul className="list-[circle] pl-5 space-y-1">
        <li>
          <strong>Self- & cross-attention:</strong> Combines both for input→output mapping.
        </li>
        <li>
          <strong>Machine translation & structured tasks:</strong> Suited for paired input-output
          data.
        </li>
      </ul>
    </li>
