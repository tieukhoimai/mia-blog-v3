  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-8">
      ...
      <article>
        ...
        <Link
          href={`/${basePath}`}
          className="mb-8 inline-block text-[12.5px] text-gray-400 transition-colors hover:text-gray-900 dark:hover:text-gray-100"
        >
          ← Back to blog
        </Link>

        {/* Eyebrow: tag · date · reading time */}
        <p className="mb-3 text-[11px] tracking-[0.1em] text-gray-400 dark:text-gray-600">
          {tags?.[0] && (
            <>
              <span>{tags[0]}</span>
        ...
        {/* Title */}
        <h1 className="mb-4 text-[2.2rem] font-semibold leading-[1.15] tracking-[-0.04em] text-gray-900 dark:text-gray-100 sm:text-[2.5rem]">
          {title}
        </h1>
